...
class _TransactionPhotoPageState extends State<TransactionPhotoPage> {
  ...
  void uploadImage() async{
    if(validateAndSave()){
      ...
      final StorageReference postImageRef=FirebaseStorage.instance.ref().child("Transaction Images");
      ...
      child: Form(
        ...
        child: ListView(
          children: <Widget>[
            ...
            SizedBox(height: 15),
            TextFormField(
              decoration: InputDecoration(labelText: 'Description About Expenditure'),
              validator: (value) {
